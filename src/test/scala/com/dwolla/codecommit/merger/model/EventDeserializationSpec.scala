...
class EventDeserializationSpec extends FlatSpec with Matchers with EitherValues {
             ...
             "Records": [
               {
                 "EventSource": "aws:sns",
                 "EventVersion": "1.0",
                 "EventSubscriptionArn": "arn:aws:sns:us-west-2:006467937747:CodeCommitPullRequestComments:1f05f39c-05c6-4787-a60b-89c4a4a80bae",
                 "Sns": {
                   "Type": "Notification",
                   "MessageId": "9e19450e-645d-5522-9ed4-1330f679cb70",
                   "TopicArn": "arn:aws:sns:us-west-2:006467937747:CodeCommitPullRequestComments",
                   "Subject": null,
                   "Message": "{\"account\":\"006467937747\",\"detailType\":\"CodeCommit Comment on Pull Request\",\"region\":\"us-west-2\",\"source\":\"aws.codecommit\",\"time\":\"2019-11-07T21:42:55Z\",\"notificationRuleArn\":\"arn:aws:codestar-notifications:us-west-2:006467937747:notificationrule/a1f30755-35a7-4509-8cd5-9ceacfe2b1b7\",\"detail\":{\"beforeCommitId\":\"98e51570918535a481ba6a24338f9a30cd264ed3\",\"inReplyTo\":\"164f09cc-a5db-4ee1-92b3-507cc10eb7ec:0495e3ea-5e38-49b9-9151-96d009e750cb\",\"notificationBody\":\"A pull request event occurred in the following AWS CodeCommit repository: codecommit-merge-on-comment. arn:aws:sts::006467937747:assumed-role/IT-Admin/bholt made a comment or replied to a comment. The comment was made on the following Pull Request: 3. For more information, go to the AWS CodeCommit console https://us-west-2.console.aws.amazon.com/codesuite/codecommit/repositories/codecommit-merge-on-comment/pull-requests/3/activity#164f09cc-a5db-4ee1-92b3-507cc10eb7ec%3A131232f8-b22f-4cd9-87a1-84f005de25d4?region=us-west-2\",\"repositoryId\":\"555f2590-a675-47a0-b35e-bc1c0e5b1822\",\"commentId\":\"164f09cc-a5db-4ee1-92b3-507cc10eb7ec:131232f8-b22f-4cd9-87a1-84f005de25d4\",\"afterCommitId\":\"bac94b54d10cbc6c121386f51e91e002e940fc19\",\"callerUserArn\":\"arn:aws:sts::006467937747:assumed-role/IT-Admin/bholt\",\"event\":\"commentOnPullRequestCreated\",\"pullRequestId\":\"3\",\"repositoryName\":\"codecommit-merge-on-comment\"},\"resources\":[\"arn:aws:codecommit:us-west-2:006467937747:codecommit-merge-on-comment\"],\"additionalAttributes\":{\"commentedLine\":null,\"resourceArn\":\"arn:aws:codecommit:us-west-2:006467937747:codecommit-merge-on-comment\",\"comments\":[{\"authorArn\":\"arn:aws:sts::006467937747:assumed-role/IT-Admin/bholt\",\"commentText\":\"comment comment comment\"},{\"authorArn\":\"arn:aws:sts::006467937747:assumed-role/IT-Admin/bholt\",\"commentText\":\"comment after policy change\"}],\"commentedLineNumber\":null,\"filePath\":null}}",
                   ...
                   "UnsubscribeUrl": "https://sns.us-west-2.amazonaws.com/?Action=Unsubscribe&SubscriptionArn=arn:aws:sns:us-west-2:006467937747:CodeCommitPullRequestComments:1f05f39c-05c6-4787-a60b-89c4a4a80bae",
                   "MessageAttributes": {}
                 }
               }
             ]
  ...
  it should "decode the input with the message as decodable type" in {
    ...
    val parsed: List[Json] =
      messagesInRecordsTraversal[Json](snsInput)
